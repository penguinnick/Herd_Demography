...
ggsave( "Figures/Fig6_stochastic_rep.jpg", plot =  Fig7 , width = 6, height = 4)
...
plot.projection(new.pop.res.df %>% 
                  filter(str_detect(strategy, "Benkovac-Barice|MilkA")), 
...
Fig8
ggsave( "Figures/Fig7_reprojections.jpg", plot =  Fig8 , width = 6, height = 4)
...
Fig9
ggsave( "Figures/Fig8_mean_herd_size.jpg", plot =  Fig9 , width = 6, height = 4)
...
plot.m = function( taxon = c("goat", "sheep")){
  ...
  all.m.df %>% 
    ...
    theme(legend.position = "bottom", 
          ...
          line = element_line(linewidth = 0.2)) +
    if(tax == "goat"){
      facet_wrap( ~ strategy , scales = "free_y", labeller = as_labeller(goat_labels) ) # goat_labeller )
    } else {
      facet_wrap( ~ strategy , scales = "free_y", labeller = as_labeller(sheep_labels)) #  sheep_labeller )
    }
}
...
# Fig8
ggsave( "Figures/Fig9_Lambda_goat.jpg", plot =  plot.m("goat") , width = 6, height = 4)
# Fig9
ggsave( "Figures/Fig10_Lambda_sheep.jpg", plot =  plot.m("sheep") , width = 6, height = 4)
```
