...
```{r, theoretical-offtake-models, include=TRUE}
HerdDynamics::culling_multiplot(HerdDynamics::offtake_models)
```

```{r, theoretical-survivorship-table, echo=FALSE, include=FALSE, eval=TRUE, results="hide"}
...
culling.profiles2 = lapply( ages.list, function(l) {
  ...
  l$s[9] = HI
  c( 100, l$s * 100 ) })
culling.profiles = culling.profiles2
