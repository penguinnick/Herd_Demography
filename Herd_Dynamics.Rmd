...
#-- save figure
# ggsave(Fig4, filename = "Figures/Fig4_lambda-boot.jpg", dpi = 300, width = 6, height = 4)
```
...
```{r Figure5, echo=-3, fig.dim=c(6,4), include=FALSE, eval=FALSE}
...
Fig5
# ggsave("Figures/Fig5_herd_structure.jpg", Fig5, width = 6, height = 4)
```
...
```{r, Fig6, echo=FALSE, warning=FALSE, fig.dim=c(6,4), fig.cap="Figure. 6. Plots showing the change in sheep and goat herd sizes through time under the various survivorship profiles used. " }
#-- plot
Fig6 = tot.pop.df %>% 
...
# ggsave( "Figures/Fig6_projections.jpg", plot =  Fig6 , width = 6, height = 4)
...
Fig8
ggsave( "Figures/Fig8_reprojections.jpg", plot =  Fig6 , width = 6, height = 4)
